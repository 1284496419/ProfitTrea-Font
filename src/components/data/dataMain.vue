<template>
  <div class="main">
    <h1 class="market-title">提供市场实时数据</h1>
    <div class="dm-container">
      <div class="dm-left">
        <div class="dm-title">
          <span>实时数据</span>
        </div>
        <div class="dm-left right">
          <div class="dm-title dmr-title">
            <span>获取当天实时的数据</span>
          </div>

        </div>
        <div class="dm-content">
          <el-tabs :tab-position="tabPosition" id="dm-tab">
